    ...
    return (
      <div className="absolute inset-0 bg-black min-h screen">
        <div className="p-8 grid gap-4 bg-black">
          <div>
            <h1 className="text-3xl mr-36 text-white">Photos of {place.title}</h1>
            <button onClick={() => setShowAllPhotos(false)} className="fixed text-black right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-white shadow shadow-black">
